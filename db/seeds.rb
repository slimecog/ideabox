...
Idea.create!(title: "title1", content: "idea 1", user_id: 1, category_id: 1, image_id: 1)
Idea.create!(title: "title2", content: "idea 2", user_id: 1, category_id: 2, image_id: 2)
Idea.create!(title: "title3", content: "idea 3", user_id: 2, category_id: 1, image_id: 2)
Idea.create!(title: "title4", content: "idea 4", user_id: 2, category_id: 2, image_id: 3)
Idea.create!(title: "title5", content: "idea 5", user_id: 2, category_id: 3, image_id: 3)
